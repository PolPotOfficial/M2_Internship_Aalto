...
origins <- st_read("/users/eleves-b/2023/wenrui.dai/Desktop/environment/Helsinki/TD_origins_15.gpkg")
destinations <- st_read("/users/eleves-b/2023/wenrui.dai/Desktop/environment/Helsinki/TD_destinations_15.gpkg")
...
Batch_num <- 0415
outFile <- paste0(outFolder, "/Helsinki_H3_r5rDI_", Sys.Date(), "_TD_", Batch_num, "_n", ".csv")
